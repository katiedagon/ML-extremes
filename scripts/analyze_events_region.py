...
def analyze_events(event_masks_xarray, class_masks_xarray, results_dir):
    ...
    def visualize_frequency_map(frequency_map, title, colorbar_text, filepath):
        ...
        lon = np.linspace(180,255,frequency_map.shape[1])
        lat = np.linspace(25,65,frequency_map.shape[0])
    ...
    # KD modify to return genesis/termination data
    return(genesis_frequency_ar, genesis_frequency_tc, termination_frequency_ar,
           termination_frequency_tc)
